...
Code in libraries is the most important part of **netizens-core** project and it is maintained by the Bitshares Core Team and contributors.
# Available Libraries
...
[fc](fc) | Fast-compiling C++ library | https://github.com/bitshares/netizens-fc | Active 
[net](net) | Network | The graphene p2p layer. | Active 
[plugins](plugins) | Plugins | Collection of singleton designed modules used for extending the netizens-core.  | Active 
